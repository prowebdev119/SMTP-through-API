...
<body>
	...
	<div class="main">
		...
		<div class="row col-md-12">
			<div class="col-md-6">
				<div class="main_input" id="openEmail" style="margin: 0 auto;">
					<div class="plus">+</div>
					<div class="main_txt"><?= $lang['left_blck_title']; ?></div>
					<a href="mailto:supper@onemak.com" style="position: absolute; display:block; width:100%; height:100%;"></a>
				</div>
			</div>
			<div class="col-md-6">
				<div class="main_input" id="openPopup" style="margin: 0 auto;">
					<div class="plus">+</div>
					<div class="main_txt"><?= $lang['right_blck_title']; ?></div>
				</div>
			</div>
		</div>
	...
	<form action="./emailsend.php" id="popup" class="popup" method="POST" enctype="multipart/form-data" onsubmit="return submitUserForm()">
		...
		<div class="popup_content">
			...
			<div class="popup_main">
				<div class="row">
					<div class="col-md-6">
						<div class="pop_title"><?= $lang['first_name']; ?></div>
						<input type="text" name="first_name" class="form-control" placeholder="First Name" required>
					</div>
					<div class="col-md-6">
						<div class="pop_title"><?= $lang['last_name']; ?></div>
						<input type="text" name="last_name" class="form-control" placeholder="First Name">
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="pt-4 pop_title"><?= $lang['email_add']; ?></div>
						<input type="email" name="from_email" class="form-control" placeholder="Your Email" required>
					</div>
					<div class="col-md-6">
						<div class="pt-4 pop_title"><?= $lang['row_2']; ?></div>
						<select name="priority" class="custom-select">
							<option value="Low">Low</option>
							<option value="Medium">Medium</option>
							<option value="High or Critical">High</option>
						</select>
					</div>
				</div>
				<div>
